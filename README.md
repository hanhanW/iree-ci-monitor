...
_Updated: 2026-09-09 21:48 PDT_ — `iree-org/iree`, queue samples last 10h; queued observations up to 3d
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `ubuntu-24.04` | github-hosted | 3 | 0 | — | — | 0 | [2s](https://github.com/iree-org/iree/actions/runs/34436975327/job/102743989937) | [2s](https://github.com/iree-org/iree/actions/runs/34436975327/job/102745844466) | 0% (0/3) | 3 |
...
| `.github/workflows/samples.yml` | colab | `ubuntu-24.04` | 1 | 0 | — | — | [2s](https://github.com/iree-org/iree/actions/runs/34436975327/job/102743989937) | [2s](https://github.com/iree-org/iree/actions/runs/34436975327/job/102743989937) | [2s](https://github.com/iree-org/iree/actions/runs/34436975327/job/102743989937) | 1 |
| `.github/workflows/samples.yml` | samples_summary / summary | `ubuntu-24.04` | 1 | 0 | — | — | [2s](https://github.com/iree-org/iree/actions/runs/34436975327/job/102745844466) | [2s](https://github.com/iree-org/iree/actions/runs/34436975327/job/102745844466) | [2s](https://github.com/iree-org/iree/actions/runs/34436975327/job/102745844466) | 1 |
| `.github/workflows/samples.yml` | samples | `ubuntu-24.04` | 1 | 0 | — | — | [1s](https://github.com/iree-org/iree/actions/runs/34436975327/job/102743989861) | [1s](https://github.com/iree-org/iree/actions/runs/34436975327/job/102743989861) | [1s](https://github.com/iree-org/iree/actions/runs/34436975327/job/102743989861) | 1 |

## Self-hosted runners (last 7d)

| runner | labels | jobs | fail rate | running | last seen |
|---|---|---:|---:|:---:|---:|
| `shark75-ci` | `Linux,X64,gfx1201`, `Linux,X64,gfx1201,persistent-cache`, `Linux,X64,iree-r9700`, `self-hosted,persistent-cache,Linux,X64` | 137 | 1% (2/137) |  | 12h06m ago |
| `shark10-ci` | `Linux,X64,gfx1100`, `Linux,X64,gfx1100,persistent-cache`, `Linux,X64,iree-w7900`, `Linux,X64,iree-w7900x2,persistent-cache`, `Linux,X64,rdna3`, `Linux,X64,rdna3,persistent-cache,shark10-ci`, `self-hosted,persistent-cache,Linux,X64`, `self-hosted,persistent-cache,Linux,X64,threadripper` | 113 | 5% (6/113) |  | 12h11m ago |
| `shark01-ci` | `Linux,X64,gfx1100`, `Linux,X64,gfx1100,persistent-cache`, `Linux,X64,iree-w7900`, `Linux,X64,iree-w7900x2,persistent-cache`, `Linux,X64,rdna3`, `self-hosted,persistent-cache,Linux,X64`, `self-hosted,persistent-cache,Linux,X64,threadripper` | 102 | 1% (1/102) |  | 12h12m ago |
| `shark55-ci` | `Linux,X64,gfx1100`, `Linux,X64,gfx1100,persistent-cache`, `Linux,X64,rdna3`, `self-hosted,persistent-cache,Linux,X64` | 93 | 0% (0/93) |  | 12h12m ago |
