...
_Updated: 2026-09-06 13:27 PDT_ — `iree-org/iree`, queue samples last 10h; queued observations up to 3d
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `Linux,X64,gfx1201` | self-hosted | 2 | 1 | [50m45s](https://github.com/iree-org/iree/actions/runs/34054951336/job/101546350943) | 2026-09-06 13:27 PDT | 1 | [45m43s](https://github.com/iree-org/iree/actions/runs/34054951336/job/101546350828) | [45m43s](https://github.com/iree-org/iree/actions/runs/34054951336/job/101546350828) | — | `shark75-ci` |
...
| `ubuntu-latest` | github-hosted | 15 | 0 | — | — | 0 | [2s](https://github.com/iree-org/iree/actions/runs/34038241030/job/101500155815) | [3s](https://github.com/iree-org/iree/actions/runs/34038240075/job/101500152846) | 0% (0/3) | 15 |
| `ubuntu-24.04` | github-hosted | 24 | 0 | — | — | 0 | [2s](https://github.com/iree-org/iree/actions/runs/34054951144/job/101545126669) | [3s](https://github.com/iree-org/iree/actions/runs/34030303831/job/101478468373) | 0% (0/19) | 24 |
...
| `Linux,X64,gfx1201,persistent-cache` | self-hosted | 1 | 1 | [50m46s](https://github.com/iree-org/iree/actions/runs/34054951336/job/101546350837) | 2026-09-06 13:27 PDT | 0 | 0s | 0s | — | 0 |

## Longest observed queued jobs (last 3d)

| wait | observed | workflow | job | labels | branch | event |
|---:|---:|---|---|---|---|---|
| [50m46s](https://github.com/iree-org/iree/actions/runs/34054951336/job/101546350837) | 2026-09-06 13:27 PDT | `.github/workflows/pkgci.yml` | Test ONNX / test_onnx_models :: amdgpu_hip_rdna4 | `Linux,X64,gfx1201,persistent-cache` | `main` | push |
| [50m45s](https://github.com/iree-org/iree/actions/runs/34054951336/job/101546350943) | 2026-09-06 13:27 PDT | `.github/workflows/pkgci.yml` | Test Torch / test_torch_ops :: amdgpu_hip_gfx1201_O3 | `Linux,X64,gfx1201` | `main` | push |

## Workflow/job waiting time (samples last 10h, queued observations up to 3d)

| workflow | job | labels | jobs | queued | oldest queued | seen | p50 queue | p95 queue | max queue | runners |
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| `.github/workflows/pkgci.yml` | Test ONNX / test_onnx_models :: amdgpu_hip_rdna4 | `Linux,X64,gfx1201,persistent-cache` | 1 | 1 | [50m46s](https://github.com/iree-org/iree/actions/runs/34054951336/job/101546350837) | 2026-09-06 13:27 PDT | 0s | 0s | 0s | 0 |
| `.github/workflows/pkgci.yml` | Test Torch / test_torch_ops :: amdgpu_hip_gfx1201_O3 | `Linux,X64,gfx1201` | 1 | 1 | [50m45s](https://github.com/iree-org/iree/actions/runs/34054951336/job/101546350943) | 2026-09-06 13:27 PDT | 0s | 0s | 0s | 0 |
...
|---|---|---:|---:|:---:|---:|
| `shark75-ci` | `Linux,X64,gfx1201`, `Linux,X64,gfx1201,persistent-cache`, `Linux,X64,iree-r9700`, `self-hosted,persistent-cache,Linux,X64` | 127 | 2% (2/126) | yes | running |
| `shark55-ci` | `Linux,X64,gfx1100`, `Linux,X64,gfx1100,persistent-cache`, `Linux,X64,rdna3`, `self-hosted,persistent-cache,Linux,X64` | 86 | 0% (0/86) |  | 17m28s ago |
| `shark10-ci` | `Linux,X64,gfx1100`, `Linux,X64,gfx1100,persistent-cache`, `Linux,X64,iree-w7900`, `Linux,X64,iree-w7900x2,persistent-cache`, `Linux,X64,rdna3`, `Linux,X64,rdna3,persistent-cache,shark10-ci`, `self-hosted,persistent-cache,Linux,X64`, `self-hosted,persistent-cache,Linux,X64,threadripper` | 107 | 5% (5/107) |  | 24m16s ago |
| `shark01-ci` | `Linux,X64,gfx1100`, `Linux,X64,gfx1100,persistent-cache`, `Linux,X64,iree-w7900`, `Linux,X64,iree-w7900x2,persistent-cache`, `Linux,X64,rdna3`, `self-hosted,persistent-cache,Linux,X64`, `self-hosted,persistent-cache,Linux,X64,threadripper` | 97 | 0% (0/97) |  | 25m28s ago |
