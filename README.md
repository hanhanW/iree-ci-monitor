...
_Updated: 2026-04-23T21:07Z_ — `iree-org/iree`, last 6h
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| `self-hosted,persistent-cache,Linux,X64,threadripper` | 43 | 25 | 3h57m | 1 | 0s | 2h53m | 0% (0/2) | 2 |
| `Linux,X64,iree-w7900` | 22 | 8 | 3h09m | 0 | 2s | 2h21m | 0% (0/2) | 2 |
| `Linux,X64,iree-r9700` | 22 | 4 | 3h09m | 0 | 32m24s | 2h17m | 0% (0/5) | 1 |
| `Linux,X64,rdna3,persistent-cache,shark10-ci` | 22 | 5 | 2h16m | 0 | 15m34s | 2h03m | 0% (0/4) | 1 |
| `Linux,X64,gfx1100` | 44 | 5 | 46m21s | 1 | 25m39s | 1h51m | 0% (0/8) | 3 |
| `Linux,X64,gfx1201` | 44 | 21 | 3h57m | 0 | 0s | 1h39m | 0% (0/4) | 1 |
| `Linux,X64,rdna3,shark10-ci` | 22 | 12 | 3h57m | 0 | 0s | 1h32m | 0% (0/1) | 1 |
| `Linux,X64,gfx1201,persistent-cache` | 22 | 6 | 2h46m | 1 | 17m22s | 1h31m | 0% (0/3) | 1 |
| `Linux,X64,iree-w7900x2,persistent-cache` | 22 | 6 | 3h25m | 0 | 5m00s | 1h27m | 60% (3/5) | 2 |
| `Linux,X64,rdna3` | 22 | 2 | 18m32s | 0 | 29m52s | 1h26m | 0% (0/5) | 3 |
| `self-hosted,persistent-cache,Linux,X64` | 45 | 3 | 18m32s | 1 | 13m37s | 1h17m | 0% (0/10) | 4 |
| `Linux,X64,gfx1100,persistent-cache` | 22 | 2 | 18m32s | 0 | 20m47s | 1h04m | 0% (0/5) | 3 |
| `nodai-amdgpu-mi308-x86-64` | 22 | 1 | 10m03s | 1 | 5m21s | 23m31s | 0% (0/5) | 1 |
| `linux-mi325-1gpu-ossci-iree-org` | 88 | 3 | 10m03s | 2 | 10s | 9m10s | 15% (3/20) | 85 |
| `macos-14` | 87 | 1 | 16m12s | 3 | 47s | 7m23s | 0% (0/15) | 84 |
| `ubuntu-24.04` | 429 | 9 | 10m03s | 6 | 3s | 4m47s | 1% (1/78) | 412 |
